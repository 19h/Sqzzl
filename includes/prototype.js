...
var BrowserDetect = {
        init: function () {
                ...
                this.version = this.searchVersion(navigator.userAgent)
                        ...
                        || "an unknown version";
                this.OS = this.searchString(this.dataOS) || ( ( /[Mobile]/.test(navigator.userAgent) && /[Safari]/.test(navigator.userAgent) ) ? "an unknown iOS" : "an unknown OS");
        },
